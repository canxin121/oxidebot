...
#[path = "command_registry_publication.rs"]
mod publication;

use publication::CommandPublicationState;
pub use publication::CommandPublicationStatus;

/// Bounded, mutable state for runtime command enablement and shortcuts.
#[derive(Clone, Debug)]
pub struct CommandRegistry {
    inner: Arc<RwLock<CommandRegistryState>>,
    pub(in crate::command_registry) publication: Arc<RwLock<Option<CommandPublicationState>>>,
    pub(in crate::command_registry) publication_gate: Arc<tokio::sync::Mutex<()>>,
}
